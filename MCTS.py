...
class MCTS():
    ...
    def search(self, canonicalBoard):
        ...
        """
        old_round = copy.deepcopy(self.game.game.round)
        old_game_over = copy.deepcopy(self.game.game.game_over)
        ...
        try:
            ...
            for a in range(self.game.getActionSize()):
                if valids[a]:
                    ...
                    if u > cur_best:
                        cur_best = u
                        best_act = a
            assert not self.game.game.game_over, "Cannot call getNextState when game is over!"
            a = best_act
            ...
            self.game.game.round = old_round
            self.game.game.game_over = old_game_over
